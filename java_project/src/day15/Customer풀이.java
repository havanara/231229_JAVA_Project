...
//멤버변수
	...
	protected double bonusRatio; //보너스포인트 적립 비율

//생성자
public Customer풀이() {	}

public Customer풀이(int customerID, String customerName ) {
...
public int calcPrice(int price) {
	...
	return price; //실버 등급은 할인이 없음
	
}

//출력 메서드
public void customerInfo() {
	System.out.printf(customerName+" 님 등급 ▷ "+customerGrade+"%n보너스 포인트 ▶ "+bonusPoint+"point %n");
}

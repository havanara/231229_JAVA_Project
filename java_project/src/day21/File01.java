...
public class File01 {
	...
	public static void main(String[] args) {
		/* java.io.* 에서 제공하는 클래스들은 try~catch / throw를 해줘야 함
		 * IOStream : 단방향으로 데이터가 흘러 들어가는 형태
		 ...
		 * 보조 스트림 : 직접 읽고 쓰는 기능은 없지만 추가적인 기능을 더해주는 스트림
		 *  Buffered~
		 * */
